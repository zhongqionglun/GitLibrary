...
class operate():
    ...
    def xlsx_to_dic(self, SheetName):
        while True:
            ...
            testcase = {"casename": "", "node_order": "1", "externalid": "", "version": "1", "summary": "",
                        "preconditions": "", "execution_type": "1", "importance": "1", "stepactions": "",
                        "expectedresults": "", "steps": [], "keywords": ""}
            ...
            if self.temp.getCell(self.excelSheet, self.row_flag, 7) is None and self.temp.getCell(self.excelSheet,
                                                                                                  self.row_flag + 1,
                                                                                                  7) is None:
    ...
    def write_to_file(self, ExcelFileName, SheetName):
        ...
        cp.write(str(self.content.encode('gbk')))
        cp.close()
